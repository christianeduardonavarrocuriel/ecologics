...
function initLeafletMap() {
    ...
    // Crear mapa centrado en la ubicación actual del usuario
    ...
    L.marker(depotLocation, { icon: depot })
        .addTo(map)
        .bindPopup('<b>Centro de Operaciones ECOLOGICS</b><br>Tu ubicación actual<br>Punto de inicio y fin de rutas');
    
    // Definir rutas con casas y vehículos en tu área
    const routes = [
        {
